...
import name.bagi.levente.pedometer.pedometer.CaloriesNotifier;
import name.bagi.levente.pedometer.pedometer.DistanceNotifier;
import name.bagi.levente.pedometer.pedometer.PaceNotifier;
import name.bagi.levente.pedometer.pedometer.PedometerSettings;
import name.bagi.levente.pedometer.pedometer.SpeakingTimer;
import name.bagi.levente.pedometer.pedometer.SpeedNotifier;
import name.bagi.levente.pedometer.pedometer.StepDetector;
import name.bagi.levente.pedometer.pedometer.StepDisplayer;
...
public class StepService extends Service {
    ...
    //private static final String TAG = "name.bagi";
