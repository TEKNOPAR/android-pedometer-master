...
import name.bagi.levente.pedometer.pedometer.PedometerSettings;
import name.bagi.levente.pedometer.pedometer.Settings;
import name.bagi.levente.pedometer.pedometer.Utils;
...
public class Pedometer extends Activity {
    ...
    private static String url_create_report = "http://api.teknoparbilisim.com/create_report.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gpUserID = prefs.getString("GPUSERID", null);
        ...
        btnSaveSteps = (Button) findViewById(R.id.btnSteps);


        btnSaveSteps.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "msg msg" + mStepValue, Toast.LENGTH_SHORT).show();
    ...
    class CreateNewReport extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Pedometer.this);
            pDialog.setMessage("Verileriniz Kaydediliyor...");
...
*/
            ...
            params.add(new BasicNameValuePair("STEP", mStepValue + ""));
            params.add(new BasicNameValuePair("CALORIE", mCaloriesValue + ""));
            params.add(new BasicNameValuePair("DISTANCE", mDistanceValue + ""));
            params.add(new BasicNameValuePair("SPEED", mSpeedValue + ""));
            params.add(new BasicNameValuePair("USERID", gpUserID + ""));


            // getting JSON Object
            // Note that create product url accepts POST method
            JSONObject json = jsonParser.makeHttpRequest(url_create_report,"POST", params);
